"""Phase 3 Wave 1 Task 2.18 — D1 MA Crossover integration test."""
...
def test_trend_ma_crossover_deploys_and_ticks(env_for_postgres, monkeypatch):
    ...
    with PostgresContainer("pgvector/pgvector:pg16", driver="asyncpg") as pg:
        ...
        assert "trend_ma_crossover" in registry
        assert registry["trend_ma_crossover"] is MaCrossoverStrategy
        ...
        deploy = asyncio.run(strategies_command.deploy_strategy(
            ...
            rationale="D1 MA Crossover integration test",
        ))
        ...
        async def _tick_with_golden_cross(row, cls):
        ...
        monkeypatch.setattr(worker, "_tick_one_strategy", _tick_with_golden_cross)
        try:
