"""Phase 3 Wave 1 Task 2.25 — G1 Volatility Targeting integration test."""
...
def test_vol_targeting_deploys_and_ticks(env_for_postgres, monkeypatch):
    ...
    with PostgresContainer("pgvector/pgvector:pg16", driver="asyncpg") as pg:
        ...
        assert "vol_targeting" in registry
        assert registry["vol_targeting"] is VolatilityTargetingStrategy
        ...
        deploy = asyncio.run(strategies_command.deploy_strategy(
            ...
            rationale="G1 Volatility Targeting integration test",
        ))
