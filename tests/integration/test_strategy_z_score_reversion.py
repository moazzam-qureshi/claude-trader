"""Phase 3 Wave 1 Task 2.7 — A7 Z-Score Reversion integration test."""
...
def test_z_score_reversion_deploys_and_ticks(env_for_postgres, monkeypatch):
    ...
    with PostgresContainer("pgvector/pgvector:pg16", driver="asyncpg") as pg:
        ...
        assert "z_score_reversion" in registry
        assert registry["z_score_reversion"] is ZScoreReversionStrategy
        ...
        deploy = asyncio.run(strategies_command.deploy_strategy(
            ...
            rationale="A7 Z-Score Reversion integration test",
        ))
        ...
        async def _tick_with_low_z(row, cls):
        ...
        monkeypatch.setattr(worker, "_tick_one_strategy", _tick_with_low_z)
        try:
        ...
        assert state["last_signal_kind"] == "low"
