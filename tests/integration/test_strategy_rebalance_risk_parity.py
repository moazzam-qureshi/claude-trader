"""Phase 3 Wave 1 Task 2.16 — C3 Risk Parity integration test."""
...
def test_rebalance_risk_parity_deploys_and_ticks(env_for_postgres, monkeypatch):
    ...
    with PostgresContainer("pgvector/pgvector:pg16", driver="asyncpg") as pg:
        ...
        assert "rebalance_risk_parity" in registry
        assert registry["rebalance_risk_parity"] is RiskParityStrategy
        ...
        deploy = asyncio.run(strategies_command.deploy_strategy(
            ...
            rationale="C3 Risk Parity integration test",
        ))
        ...
        # target = 0.02*1000/0.04 = 500 at 50000 → 0.01 units
